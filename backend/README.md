...
|DELETE|Remover uma situação|/api/v1.0/situacao/`<int:id_situacao>`|
...
|DELETE|Remover uma grupo|/api/v1.0/grupo/`<int:id_grupo>`|
...
|DELETE|Remover um evento|/api/v1.0/evento/`<int:id_evento>`|
...
|DELETE|Remover um fluxo|/api/v1.0/fluxo/`<int:id_fluxo>`|
